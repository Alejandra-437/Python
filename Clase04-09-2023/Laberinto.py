...
#comprueba que el juego no ha terminado todavía
  if not finish:
      ...
      if sprite.collide_rect(packman, monster) or sprite.collide_rect(packman, w1) or sprite.collide_rect(packman, w2):
          finish = True
          #calcula la tasa
          img = image.load('D:/Alejandra Serrano/PythonPro/Laberinto/Copy of game-over_1.png')
      ...
      if sprite.collide_rect(packman, final_sprite):
          finish = True
          img = image.load('D:/Alejandra Serrano/PythonPro/Laberinto/Copy of thumb.jpg')
          window.fill((255, 255, 255))
